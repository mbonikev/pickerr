...
function TopBar() {
  const buttonStyle = `text-2xl h-[40px] aspect-square flex items-center justify-center cursor-pointer bg-white hover:bg-textColorWeak/20 rounded-xl outline-none`
  return (
